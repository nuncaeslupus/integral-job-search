...
If the runtime (`jobsearch.step_runtime.offered`) is not offering `interview_log` for this candidate, defer to whichever step it does offer instead of running this one out of turn.
