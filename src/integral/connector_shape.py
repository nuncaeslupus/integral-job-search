...
`src/integral` ever executed one: `connectors.py` interprets `connector.yaml`
...
from integral.connector_contract import OPTIONAL_ENTRIES, REQUIRED_ENTRIES
...
def _main(argv: list[str]) -> int:
    """Write D-10's gate evidence. Exit 1 when the shape promises what nothing runs.
        ...
        python -m integral.connector_shape [evidence-path] [--doc PATH]
