...
fenced by a marker ending in `de29269a14fa8dffb0ec8cfe`, minted for this packet
...
----- BEGIN INTENT de29269a14fa8dffb0ec8cfe -----
---
id: t-9d41c7f5
...
----- END INTENT de29269a14fa8dffb0ec8cfe -----

## The change

- Base commit: `1e2e6c82a0858ffc6cab02ff94e032c4c67bddc7`
- Diff digest: `d4a89fd6f70ca0417ee1f8050dfa7b508e98b2be496dd57099a1055ed238ff30`
- Regenerate in full: `git diff 1e2e6c82a085` (plus untracked files below)

Files touched:

```
 connectors/robots-adjudications.yaml |  28 +++++++++++++++++++++
...
----- BEGIN DIFF de29269a14fa8dffb0ec8cfe -----
...
index 4a848d7cdc047926ae3246f7f700a88fdbbda880..274fe5c132efaa66eb02c8cd6a905abeb74a0ff8 100644
...
+#     constructed files the stdlib is — including the two where it must NOT
+#     improve on the stdlib, because refusing a path RFC 9309 allows is the
+#     opposite error and not competence.
+#
...
+#
+# So the standings below are unchanged, and the honest count stays what T116
+# committed. What T120 delivers is that it CAN now fall: a board whose
+# robots.txt is snapshotted here can be re-adjudicated with a reader able to
+# refuse, which was impossible while the second reader answered True to
+# everything. Snapshotting the remaining files needs egress, and egress is 403.
+#
...
----- END DIFF de29269a14fa8dffb0ec8cfe -----
