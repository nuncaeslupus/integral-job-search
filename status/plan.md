...
| T4b | **[LAPTOP]** Collect ≥100 raw ads (≈60 ES, 25 EN, 15 CA) for remote programming roles | 5, 8 | M | — | `raw_ad_count >= 100` | `test_raw_corpus_meets_size_and_language_mix` in `tests/test_corpus_raw.py` — ≥100 raw ads, mix within ±10% | ☑ |
