# Plan: Candidate-centred integral job search — v1 thin vertical (superseded)

> **Superseded by `status/plan.md` (v2, 2026-08-18)**, which plans against
> specification v2 — the thirteen-step process — and carries every task in this
> document forward with its status. This file is kept unedited as the record of
> what v1 planned and why, and as the source the v2 task table folds in.
